...
<body>
    ...
    <ul>
        <li><a href="/api/browser">Browser Info<a></li>
        <li><a href="/api/cf">Cloudflare Info<a></li>
        <li><a href="/api/headers">Headers Info<a></li>
        <li><a href="/api/ip">IP Info<a></li>
        <li><a href="/api/time">Time Info<a></li>
    </ul>
</body>
</html>
`
